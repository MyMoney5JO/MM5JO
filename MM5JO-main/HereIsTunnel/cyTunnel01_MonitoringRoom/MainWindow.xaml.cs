...
namespace cyTunnel01_MonitoringRoom
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        public MainWindow()
        {
            ...
            CCTV1.MediaPlayer = new MediaPlayer(_libVLC2);
            CCTV2.MediaPlayer = new MediaPlayer(_libVLC3);
            CCTV3.MediaPlayer = new MediaPlayer(_libVLC4);
            CCTV4.MediaPlayer = new MediaPlayer(_libVLC5);
        ...
        private void CCTV_PLAY()
        {
            ...
            MAIN_CCTV_PATH = "http://cctvsec.ktict.co.kr/300/SjqQJ9Kz7QiJDZ8/IRSAyUCB4zqrSdHGSUlVuueBqM178owE+UL54yvnn+c9+sPQK3pjpeA4OP58q75IUu6koUMeonPK5YgQN1UUmaz4dDk=";
